...
class FieldsModifiers(BaseModel):
    """
    FieldsModifiers
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["filter", "properties", "sortBy"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FieldsModifiers from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FieldsModifiers from a dict"""
        if obj is None:
            return None
