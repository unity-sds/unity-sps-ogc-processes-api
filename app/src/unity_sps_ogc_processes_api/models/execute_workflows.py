...
from unity_sps_ogc_processes_api.models.output_workflows import OutputWorkflows
...
class ExecuteWorkflows(BaseModel):
    ...
    process: Optional[StrictStr] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "inputs": (
                    dict((_k, InputWorkflows.from_dict(_v)) for _k, _v in obj.get("inputs").items())
                    if obj.get("inputs") is not None
                    else None
                ),
                "outputs": (
                    dict((_k, OutputWorkflows.from_dict(_v)) for _k, _v in obj.get("outputs").items())
