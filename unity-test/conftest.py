...
from app.schemas.ogc_processes import Execute, Process, StatusInfo
...
def deploy_process(client):
    ...
    client.delete(f"/processes/{process.id}")


@pytest.fixture(scope="module")
def execute_process(client, deploy_process):
    ...
    client.delete(f"/jobs/{status_info.jobID}")
